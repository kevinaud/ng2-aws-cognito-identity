...
export class AwsService {
  ...
  cognitoLogin(username, password, cb) {
    ...
    let authenticationDetails = new this.AWSCognito.AuthenticationDetails(authenticationData);
    ...
    let userPool = new this.AWSCognito.CognitoUserPool(poolData);
    ...
    let cognitoUser = new this.AWSCognito.CognitoUser(userData);
